  ...
  <div class="flex items-center justify-between">
    ...
    <router-link to="/">
      <div class="flex items-center font-extrabold space-x-2 text-xl cursor-pointer select-none">
        <div>
          <svg fill="none" class="h-6 w-6 text-yellow-400" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class='md:block w-80 pl-3'>
      <div class="relative flex items-center w-full h-12 rounded-lg bg-gray-800 overflow-hidden focus-within:border focus-within:border-gray-200">
        ...
        <input
            v-model="searchQuery"
            class="min-w-md h-full w-full bg-gray-800 outline-none text-sm text-white pr-2"
            type="text"
            id="search"
