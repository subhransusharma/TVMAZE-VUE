<template>
    <footer class="rounded-lg shadow mt-20 px-2">
      <div class="w-full">
        <div class="sm:flex sm:items-center sm:justify-between">
          <router-link to="/">
            <div class="flex items-center font-extrabold space-x-2 text-xl cursor-pointer select-none text-gray-500">
              <div>
        ...
        <span class="block text-sm  sm:text-center text-gray-400">© 2023 <a href="#" class="hover:underline">BradFlix™</a>. All Rights Reserved.</span>
      </div>
    </footer>
</template>
