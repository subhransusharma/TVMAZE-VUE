<template>
  <div>
    <div class="max-w-xl">
      <h1 class="mt-4 text-3xl leading-10 sm:text-4xl font-medium tracking-tight text-slate-50">Search results for <span class="italic font-extrabold">"{{$route.query.query}}"</span></h1>
    </div>
